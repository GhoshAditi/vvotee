...
web3 = new Web3(new Web3.providers.HttpProvider("HTTP://127.0.0.1:7545"));  //gnash url
// reading the file contents of the smart contract

fileContent = fs.readFileSync("demo.sol").toString();
console.log(fileContent);

// create an input structure for my solidity compiler (compiler cant run if o input cant just read file sync)
var input = {
    language: "Solidity",
    sources: {
        "demo.sol": {
